Attractors_folder="../Synthetic_Data_Analysis/FullNetwork_SampledNetwork_Comparison/Sampled_Network/Sampled_Attractor_Sets"
output_folder="../Synthetic_Data_Analysis/FullNetwork_SampledNetwork_Comparison/Sampled_Network/RESULTS"
num_bns=99
n_sets=99
if [ -d "$output_folder" ];
then
